...
<html class="">
  ...
  <body>
        ...
        <div class="row">
          <div class="border-bottom clearfix">
            <ol class="breadcrumb m-b-0 subcolumn-crumbs breadcrumb-arrow">
              ...
              <li class='breadcrumb-item'>
                <a href="login-cn.php" title="会员中心" class=''>会员中心</a></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <style>.login-index{background:;}</style>
    <div class="index_01"> 
  ...
  <tr>
    <td align="center" >
     ...
     <tr align="center" style="font-size:25px;"> 
       ...
       <tr align="center"> 
           <td colspan="2">
           <input type="submit" name="denglu" value="登陆" class="btn" style="background-color: orange;">
           <input type="reset" name="rs" value="重置" class="btn" style="background-color: orange;">  
           <input type="button" name="zu" value="注册" class="btn" onclick="window.location.href='register_include-cn.php'" style="background-color: orange;">
           </td>  
       </tr> 
     </form>
     </table>
